...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full rounded-4xl shadow-xl border border-border overflow-hidden ${stepCircleContainerClassName}`}
        style={{ maxWidth: stepCircleContainerClassName.includes('max-w-') ? undefined : '28rem' }}
      >
        <div className={`${stepContainerClassName} flex w-full items-center p-8 rounded-t-4xl`}>
